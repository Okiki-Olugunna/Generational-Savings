...
def main():
    ...
    print(f"\nThere are currently {initial_admin_number} admins for this contract\n")

    # admin will add another admin
    print(f"Adding admin: {family_member_4.address}...\n")
    ...
    print(f"Admin {family_member_4.address} has been added.\n")
